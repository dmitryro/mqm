...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.local_mind'
        db.add_column(u'local_map_map', 'local_mind',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='partners', to=orm['local_minds.LocalMind']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.local_mind'
        db.delete_column(u'local_map_map', 'local_mind_id')
