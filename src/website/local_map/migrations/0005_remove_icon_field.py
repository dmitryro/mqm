...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Marker.icon'
        db.delete_column(u'local_map_marker', 'icon_id')


    def backwards(self, orm):
        # Adding field 'Marker.icon'
        db.add_column(u'local_map_marker', 'icon',
                      self.gf('mediastore.fields.related.MediaField')(default=None, related_name='marker_image', to=orm['mediastore.Media']),
                      keep_default=False)
