...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map._latitude_postcode'
        db.add_column(u'local_map_map', '_latitude_postcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Map._longitude_postcode'
        db.add_column(u'local_map_map', '_longitude_postcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map._latitude_postcode'
        db.delete_column(u'local_map_map', '_latitude_postcode')

        # Deleting field 'Map._longitude_postcode'
        db.delete_column(u'local_map_map', '_longitude_postcode')
