...
urlpatterns = patterns('',
    ...
    url(r'^meet-the-team/$', 'website.local_minds.views.local_mind_detail', name='team'),
    url(r'^meet-the-team/(?P<slug>[^/]+)/$', 'website.local_minds.views.local_mind_detail', name='team'),
