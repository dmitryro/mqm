...
class Local_DashboardView(CommonViewMixin, TemplateView):
    template_name = 'dashboard/local-dashboard.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        kwargs['local_mind_users'] = user.local_mind.users.all()
        return super(Local_DashboardView, self).get_context_data(**kwargs)


local_dashboard = Local_DashboardView.as_view()
