...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.biography'
        db.alter_column(u'accounts_user', 'biography', self.gf('django.db.models.fields.TextField')(max_length=350))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.biography'
        db.alter_column(u'accounts_user', 'biography', self.gf('django.db.models.fields.TextField')())
