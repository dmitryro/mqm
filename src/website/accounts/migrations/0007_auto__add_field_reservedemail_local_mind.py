...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReservedEmail.local_mind'
        db.add_column(u'accounts_reservedemail', 'local_mind',
    ...
    def backwards(self, orm):
        # Deleting field 'ReservedEmail.local_mind'
        db.delete_column(u'accounts_reservedemail', 'local_mind_id')
    ...
    models = {
        ...
        u'accounts.reservedemail': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_mind': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['local_minds.ReservedLocalMind']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'accounts.user': {
