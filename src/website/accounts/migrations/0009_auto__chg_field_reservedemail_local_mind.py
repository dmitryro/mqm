...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReservedEmail.local_mind'
        db.alter_column(u'accounts_reservedemail', 'local_mind_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['local_minds.LocalMind'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'ReservedEmail.local_mind'
        db.alter_column(u'accounts_reservedemail', 'local_mind_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['local_minds.ReservedLocalMind'], unique=True, null=True))
