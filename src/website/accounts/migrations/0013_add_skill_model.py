...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Skill'
        db.create_table(u'accounts_skill', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_skill')
        ...
        db.delete_table(db.shorten_name(u'accounts_user_skills'))
