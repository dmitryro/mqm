...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.privileges'
        db.add_column(u'accounts_user', 'privileges',
                      self.gf('django.db.models.fields.CharField')(default='trustee', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.privileges'
        db.delete_column(u'accounts_user', 'privileges')
