...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_reservedemail', 'local_mind_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['local_minds.LocalMind'], unique=True))
