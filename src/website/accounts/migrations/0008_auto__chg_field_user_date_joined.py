...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_user', 'date_joined', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.date_joined'
        db.alter_column(u'accounts_user', 'date_joined', self.gf('django.db.models.fields.DateTimeField')())
