...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositiveNews.list_image'
        db.add_column(u'news_positivenews', 'list_image',
                      self.gf('mediastore.fields.related.MediaField')(blank=True, related_name='positivenews_image', null=True, to=orm['mediastore.Media']),
                      keep_default=False)

        # Adding field 'ExternalNews.image'
        db.add_column(u'news_externalnews', 'image',
                      self.gf('mediastore.fields.related.MediaField')(blank=True, related_name='externalnews_image', null=True, to=orm['mediastore.Media']),
                      keep_default=False)

        # Adding field 'ExternalNews.download'
        db.add_column(u'news_externalnews', 'download',
                      self.gf('mediastore.fields.related.MediaField')(blank=True, related_name='externalnews_download', null=True, to=orm['mediastore.Media']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositiveNews.list_image'
        db.delete_column(u'news_positivenews', 'list_image_id')

        # Deleting field 'ExternalNews.image'
        db.delete_column(u'news_externalnews', 'image_id')

        # Deleting field 'ExternalNews.download'
        db.delete_column(u'news_externalnews', 'download_id')
    ...
    models = {
        ...
        u'news.externalnews': {
            ...
            'download': ('mediastore.fields.related.MediaField', [], {'blank': 'True', 'related_name': "'externalnews_download'", 'null': 'True', 'to': "orm['mediastore.Media']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('mediastore.fields.related.MediaField', [], {'blank': 'True', 'related_name': "'externalnews_image'", 'null': 'True', 'to': "orm['mediastore.Media']"}),
        ...
        u'news.positivenews': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list_image': ('mediastore.fields.related.MediaField', [], {'blank': 'True', 'related_name': "'positivenews_image'", 'null': 'True', 'to': "orm['mediastore.Media']"}),
