...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositiveNews.local_mind'
        db.add_column(u'news_positivenews', 'local_mind',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='positivenews', to=orm['local_minds.LocalMind']),
                      keep_default=False)

        # Adding field 'ExternalNews.local_mind'
        db.add_column(u'news_externalnews', 'local_mind',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='externalnews', to=orm['local_minds.LocalMind']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositiveNews.local_mind'
        db.delete_column(u'news_positivenews', 'local_mind_id')

        # Deleting field 'ExternalNews.local_mind'
        db.delete_column(u'news_externalnews', 'local_mind_id')
    ...
    models = {
        ...
        u'news.externalnews': {
            ...
            'source': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
