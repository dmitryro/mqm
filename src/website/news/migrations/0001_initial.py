...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalNews'
        db.create_table(u'news_externalnews', (
            ...
            ('source', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('privacy', self.gf('website.privacy.fields.PrivacyField')(default='national', max_length=12)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'news', ['ExternalNews'])

        # Adding model 'PositiveNews'
        db.create_table(u'news_positivenews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
        ...
        db.send_create_signal(u'news', ['PositiveNews'])


    def backwards(self, orm):
        # Deleting model 'ExternalNews'
        db.delete_table(u'news_externalnews')

        # Deleting model 'PositiveNews'
        db.delete_table(u'news_positivenews')
