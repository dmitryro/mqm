...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'PositiveNews.author'
        db.rename_column(u'news_positivenews', 'author_id', 'user_id')

        # Rename field 'ExternalNews.author'
        db.rename_column(u'news_externalnews', 'author_id', 'user_id')


    def backwards(self, orm):
        # Rename field 'PositiveNews.user'
        db.rename_column(u'news_positivenews', 'user_id', 'author_id')

        # Rename field 'ExternalNews.user'
        db.rename_column(u'news_externalnews', 'user_id', 'author_id')
