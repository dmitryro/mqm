...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PositiveNews', fields ['slug']
        db.create_unique(u'news_positivenews', ['slug'])

        # Adding unique constraint on 'ExternalNews', fields ['slug']
        db.create_unique(u'news_externalnews', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExternalNews', fields ['slug']
        db.delete_unique(u'news_externalnews', ['slug'])

        # Removing unique constraint on 'PositiveNews', fields ['slug']
        db.delete_unique(u'news_positivenews', ['slug'])
