...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositiveNews.download'
        db.add_column(u'news_positivenews', 'download',
                      self.gf('mediastore.fields.related.MediaField')(blank=True, related_name='positivenews_download', null=True, to=orm['mediastore.Media']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositiveNews.download'
        db.delete_column(u'news_positivenews', 'download_id')
    ...
    models = {
        ...
        u'news.positivenews': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'download': ('mediastore.fields.related.MediaField', [], {'blank': 'True', 'related_name': "'positivenews_download'", 'null': 'True', 'to': "orm['mediastore.Media']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
