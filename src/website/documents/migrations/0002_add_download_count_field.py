...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.download_count'
        db.add_column(u'documents_document', 'download_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.download_count'
        db.delete_column(u'documents_document', 'download_count')
