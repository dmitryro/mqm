...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.local_mind'
        db.add_column(u'videos_video', 'local_mind',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='videos', null=True, to=orm['local_minds.LocalMind']),
                      keep_default=False)


        # Changing field 'Video.slug'
        db.alter_column(u'videos_video', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', unique=True, populate_from=('title',), overwrite=False))

        # Changing field 'Video.privacy'
        db.alter_column(u'videos_video', 'privacy', self.gf('website.privacy.fields.PrivacyField')(max_length=12))

    def backwards(self, orm):
        # Deleting field 'Video.local_mind'
        db.delete_column(u'videos_video', 'local_mind_id')


        # Changing field 'Video.slug'
        db.alter_column(u'videos_video', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Video.privacy'
        db.alter_column(u'videos_video', 'privacy', self.gf('django.db.models.fields.CharField')(max_length=120))
    ...
    models = {
        ...
        u'videos.video': {
            'Meta': {'ordering': "('-date',)", 'object_name': 'Video'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_mind': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'videos'", 'null': 'True', 'to': u"orm['local_minds.LocalMind']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'videos'", 'null': 'True', 'to': u"orm['accounts.User']"})
        }
    }
