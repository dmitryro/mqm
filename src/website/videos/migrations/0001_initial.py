...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'videos_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'videos', ['Tag'])
        ...
        db.create_table(u'videos_video', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='videos', null=True, to=orm['accounts.User'])),
        ...
        db.create_table(m2m_table_name, (
            ...
            ('tag', models.ForeignKey(orm[u'videos.tag'], null=False))
        ))
