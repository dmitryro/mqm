...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'diary_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('privacy', self.gf('website.privacy.fields.PrivacyField')(default='national', max_length=12)),
            ('_latitude_postcode', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('_longitude_postcode', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['accounts.User'])),
            ('local_mind', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['local_minds.LocalMind'])),
        ...
        db.send_create_signal(u'diary', ['Event'])


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table(u'diary_event')
    ...
    models = {
        ...
        u'diary.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_mind': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': u"orm['local_minds.LocalMind']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': u"orm['accounts.User']"})
        },
