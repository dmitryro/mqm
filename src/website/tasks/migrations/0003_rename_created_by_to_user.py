...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'tasks_task', 'created_by_id', 'user_id')
        db.rename_column(u'tasks_comment', 'author_id', 'user_id')


    def backwards(self, orm):
        db.rename_column(u'tasks_task', 'user_id', 'created_by_id')
        db.rename_column(u'tasks_comment', 'user_id', 'author_id')
    ...
    models = {
        ...
        u'tasks.comment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'task_comments'", 'to': u"orm['accounts.User']"})
        },
        u'tasks.task': {
            ...
            'text': ('django.db.models.fields.CharField', [], {'max_length': '141'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_tasks'", 'to': u"orm['accounts.User']"})
        }
    }
