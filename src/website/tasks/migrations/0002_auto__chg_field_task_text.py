...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.text'
        db.alter_column(u'tasks_task', 'text', self.gf('django.db.models.fields.CharField')(max_length=141))

    def backwards(self, orm):

        # Changing field 'Task.text'
        db.alter_column(u'tasks_task', 'text', self.gf('django.db.models.fields.TextField')())
