...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalMind.area_of_benefit'
        db.alter_column(u'local_minds_localmind', 'area_of_benefit', self.gf('django.db.models.fields.CharField')(max_length=350))

    def backwards(self, orm):

        # Changing field 'LocalMind.area_of_benefit'
        db.alter_column(u'local_minds_localmind', 'area_of_benefit', self.gf('django.db.models.fields.CharField')(max_length=50))
