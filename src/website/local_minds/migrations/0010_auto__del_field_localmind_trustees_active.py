...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocalMind.trustees_active'
        db.delete_column(u'local_minds_localmind', 'trustees_active')


    def backwards(self, orm):
        # Adding field 'LocalMind.trustees_active'
        db.add_column(u'local_minds_localmind', 'trustees_active',
