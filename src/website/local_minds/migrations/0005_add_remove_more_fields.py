...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalMind.hours'
        db.add_column(u'local_minds_localmind', 'hours',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'LocalMind.area_of_benefit'
        db.add_column(u'local_minds_localmind', 'area_of_benefit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'LocalMind.average_volunteer_hours'
        db.add_column(u'local_minds_localmind', 'average_volunteer_hours',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'LocalMind.hours'
        db.delete_column(u'local_minds_localmind', 'hours')

        # Deleting field 'LocalMind.area_of_benefit'
        db.delete_column(u'local_minds_localmind', 'area_of_benefit')

        # Deleting field 'LocalMind.average_volunteer_hours'
        db.delete_column(u'local_minds_localmind', 'average_volunteer_hours')
