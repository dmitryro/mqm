...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('accounts', '0010_assign_random_local_minds_to_reserved_emails'),
    )

    def forwards(self, orm):
        # Deleting model 'ReservedLocalMind'
        db.delete_table(u'local_minds_reservedlocalmind')

        # Deleting field 'LocalMind.reserved_local_mind'
        db.delete_column(u'local_minds_localmind', 'reserved_local_mind_id')


    def backwards(self, orm):
        # Adding model 'ReservedLocalMind'
        db.create_table(u'local_minds_reservedlocalmind', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'local_minds', ['ReservedLocalMind'])

        # Adding field 'LocalMind.reserved_local_mind'
        db.add_column(u'local_minds_localmind', 'reserved_local_mind',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['local_minds.ReservedLocalMind'], unique=True, null=True, blank=True),
                      keep_default=False)
