...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalMind._latitude_postcode'
        db.add_column(u'local_minds_localmind', '_latitude_postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LocalMind._longitude_postcode'
        db.add_column(u'local_minds_localmind', '_longitude_postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalMind._latitude_postcode'
        db.delete_column(u'local_minds_localmind', '_latitude_postcode')

        # Deleting field 'LocalMind._longitude_postcode'
        db.delete_column(u'local_minds_localmind', '_longitude_postcode')
