...
class LocalMind(PostcodeLocationMixin, models.Model):
    ...
    income_restricted = models.CharField(_('LM income (restricted)'), max_length=50, blank=True)
    income_unrestricted = models.CharField(_('LM income (unrestricted)'), max_length=50, blank=True)
