...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Funding._latitude_postcode'
        db.add_column(u'funding_map_funding', '_latitude_postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Funding._longitude_postcode'
        db.add_column(u'funding_map_funding', '_longitude_postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Funding.local_mind'
        db.add_column(u'funding_map_funding', 'local_mind',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fundings', null=True, to=orm['local_minds.LocalMind']),
                      keep_default=False)

        # Adding field 'Funding.user'
        db.add_column(u'funding_map_funding', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fundings', null=True, to=orm['accounts.User']),
                      keep_default=False)

        # Adding field 'Funding.slug'
        db.add_column(u'funding_map_funding', 'slug',
        ...
        # Changing field 'Funding.privacy'
        db.alter_column(u'funding_map_funding', 'privacy', self.gf('website.privacy.fields.PrivacyField')(max_length=12))

    def backwards(self, orm):
        # Deleting field 'Funding._latitude_postcode'
        db.delete_column(u'funding_map_funding', '_latitude_postcode')

        # Deleting field 'Funding._longitude_postcode'
        db.delete_column(u'funding_map_funding', '_longitude_postcode')

        # Deleting field 'Funding.local_mind'
        db.delete_column(u'funding_map_funding', 'local_mind_id')

        # Deleting field 'Funding.user'
        db.delete_column(u'funding_map_funding', 'user_id')

        # Deleting field 'Funding.slug'
        db.delete_column(u'funding_map_funding', 'slug')


        # Changing field 'Funding.privacy'
        db.alter_column(u'funding_map_funding', 'privacy', self.gf('django.db.models.fields.CharField')(max_length=120))
    ...
    models = {
        ...
        u'funding_map.funding': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_mind': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fundings'", 'null': 'True', 'to': u"orm['local_minds.LocalMind']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fundings'", 'null': 'True', 'to': u"orm['accounts.User']"}),
