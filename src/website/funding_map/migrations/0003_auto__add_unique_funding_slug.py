...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Funding', fields ['slug']
        db.create_unique(u'funding_map_funding', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Funding', fields ['slug']
        db.delete_unique(u'funding_map_funding', ['slug'])
